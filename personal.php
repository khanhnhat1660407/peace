        ...
        <div style="text-align: center;">
            <div class="card" style="width: 80%; margin: 0 auto; border-radius: 20px ">
                <div class="card-body">
                    <div id="user-info-avatar">
                        <img style="width: 200px;height: 200px; border-radius: 50%;"
                             src="uploads/<?php echo $currentUser['id']; ?>.jpg">
                        <p><h4 class="user-name"><?php echo $currentUser['username']; ?></h4></p>
                        <form method="POST" id="form-update-avatar">
                            <button type="submit" title="Cập nhật ảnh đại diện" class="btn btn-white"
                                    data-toggle="modal" name="update-avatar" id="update-avatar"><i class="fa fa-camera"
                                                                                                   aria-hidden="true"></i>
                            </button>
                ...
                <div class="card" id="navigation">
                    <button type="button" class="button-navigation" name="timeline-btn" id="timeline-btn"
                            style=" text-decoration: none">Dòng thời gian
                    </button>
                    <button type="button" class="button-navigation" name="about-btn" id="about-btn"
                            style=" text-decoration: none;">Thông tin cá nhân
                    </button>
                    <button type="button" class="button-navigation" name="friendlist-btn" id="friendlist-btn"
                            style=" text-decoration: none;">Bạn bè
                    </button>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body"><h5>
                                <a href="profile.php?id=<?php echo $friendInfo['id']; ?>">
                                    <img style="width: 50px;height: 50px; border-radius: 50%;"
                                         src="uploads/<?php echo $friendInfo['id']; ?>.jpg">
                    ...
                    <div class="card-body">
                        ...
                        <form class="clearfix" action="personal.php" method="post"
                            ...
                            <div class="comment-area">
                                ...
                                <input name="comment_text" id="comment_text_<?php echo $post['id'] ?>"
